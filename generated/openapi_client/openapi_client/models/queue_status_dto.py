...
class QueueStatusDto(BaseModel):
    ...
    __properties = ["isActive", "isPaused"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QueueStatusDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> QueueStatusDto:
        """Create an instance of QueueStatusDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QueueStatusDto.parse_obj(obj)

        _obj = QueueStatusDto.parse_obj({

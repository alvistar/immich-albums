...
class UpdateUserDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["avatarColor", "email", "externalPath", "id", "isAdmin", "memoriesEnabled", "name", "password", "quotaSizeInBytes", "shouldChangePassword", "storageLabel"]

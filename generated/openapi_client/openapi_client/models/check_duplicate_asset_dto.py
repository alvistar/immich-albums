...
class CheckDuplicateAssetDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CheckDuplicateAssetDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CheckDuplicateAssetDto:
        """Create an instance of CheckDuplicateAssetDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CheckDuplicateAssetDto.parse_obj(obj)

        _obj = CheckDuplicateAssetDto.parse_obj({

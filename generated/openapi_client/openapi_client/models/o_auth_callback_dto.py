...
class OAuthCallbackDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OAuthCallbackDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OAuthCallbackDto:
        """Create an instance of OAuthCallbackDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OAuthCallbackDto.parse_obj(obj)

        _obj = OAuthCallbackDto.parse_obj({
            "url": obj.get("url")
        })
        return _obj

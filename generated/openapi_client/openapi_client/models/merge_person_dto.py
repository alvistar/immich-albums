...
class MergePersonDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MergePersonDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MergePersonDto:
        """Create an instance of MergePersonDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MergePersonDto.parse_obj(obj)

        _obj = MergePersonDto.parse_obj({
            "ids": obj.get("ids")
        })
        return _obj

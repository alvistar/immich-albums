...
class LoginCredentialDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoginCredentialDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoginCredentialDto:
        """Create an instance of LoginCredentialDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoginCredentialDto.parse_obj(obj)

        _obj = LoginCredentialDto.parse_obj({
            "email": obj.get("email"),

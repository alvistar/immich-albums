...
class SystemConfigNewVersionCheckDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SystemConfigNewVersionCheckDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SystemConfigNewVersionCheckDto:
        """Create an instance of SystemConfigNewVersionCheckDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SystemConfigNewVersionCheckDto.parse_obj(obj)

        _obj = SystemConfigNewVersionCheckDto.parse_obj({

...
class AssetFaceUpdateItem(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AssetFaceUpdateItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AssetFaceUpdateItem:
        """Create an instance of AssetFaceUpdateItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AssetFaceUpdateItem.parse_obj(obj)

        _obj = AssetFaceUpdateItem.parse_obj({

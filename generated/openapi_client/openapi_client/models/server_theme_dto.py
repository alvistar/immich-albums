...
class ServerThemeDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerThemeDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerThemeDto:
        """Create an instance of ServerThemeDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServerThemeDto.parse_obj(obj)

        _obj = ServerThemeDto.parse_obj({

...
class APIKeyUpdateDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> APIKeyUpdateDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> APIKeyUpdateDto:
        """Create an instance of APIKeyUpdateDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return APIKeyUpdateDto.parse_obj(obj)

        _obj = APIKeyUpdateDto.parse_obj({
            "name": obj.get("name")
        })
        return _obj

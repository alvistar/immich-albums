...
class SystemConfigMapDto(BaseModel):
    ...
    __properties = ["darkStyle", "enabled", "lightStyle"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SystemConfigMapDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SystemConfigMapDto:
        """Create an instance of SystemConfigMapDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SystemConfigMapDto.parse_obj(obj)

        _obj = SystemConfigMapDto.parse_obj({
            "dark_style": obj.get("darkStyle"),
            "enabled": obj.get("enabled"),
            "light_style": obj.get("lightStyle")
        })
        return _obj

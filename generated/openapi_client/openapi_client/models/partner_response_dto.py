...
class PartnerResponseDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["avatarColor", "createdAt", "deletedAt", "email", "id", "inTimeline", "isAdmin", "memoriesEnabled", "name", "oauthId", "profileImagePath", "quotaSizeInBytes", "quotaUsageInBytes", "shouldChangePassword", "status", "storageLabel", "updatedAt"]

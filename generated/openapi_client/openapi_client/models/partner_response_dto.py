...
class PartnerResponseDto(BaseModel):
    ...
    __properties = ["avatarColor", "createdAt", "deletedAt", "email", "externalPath", "id", "inTimeline", "isAdmin", "memoriesEnabled", "name", "oauthId", "profileImagePath", "shouldChangePassword", "storageLabel", "updatedAt"]

...
class PartnerResponseDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["avatarColor", "createdAt", "deletedAt", "email", "externalPath", "id", "inTimeline", "isAdmin", "memoriesEnabled", "name", "oauthId", "profileImagePath", "quotaSizeInBytes", "quotaUsageInBytes", "shouldChangePassword", "storageLabel", "updatedAt"]

...
class AddUsersDto(BaseModel):
    ...
    AddUsersDto
    """ # noqa: E501
    album_users: List[AlbumUserAddDto] = Field(alias="albumUsers")
    shared_user_ids: Optional[List[StrictStr]] = Field(default=None, description="This property was deprecated in v1.102.0", alias="sharedUserIds")
    __properties: ClassVar[List[str]] = ["albumUsers", "sharedUserIds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sharedUserIds": obj.get("sharedUserIds")
        })
        return _obj

...
class CreateAlbumDto(BaseModel):
    ...
    shared_with_user_ids: Optional[List[StrictStr]] = Field(default=None, alias="sharedWithUserIds")
    __properties: ClassVar[List[str]] = ["albumName", "assetIds", "description", "sharedWithUserIds"]

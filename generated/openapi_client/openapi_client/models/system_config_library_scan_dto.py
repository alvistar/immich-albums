...
class SystemConfigLibraryScanDto(BaseModel):
    ...
    __properties = ["cronExpression", "enabled"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SystemConfigLibraryScanDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SystemConfigLibraryScanDto:
        """Create an instance of SystemConfigLibraryScanDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SystemConfigLibraryScanDto.parse_obj(obj)

        _obj = SystemConfigLibraryScanDto.parse_obj({

...
class SystemConfigLoggingDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SystemConfigLoggingDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SystemConfigLoggingDto:
        """Create an instance of SystemConfigLoggingDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SystemConfigLoggingDto.parse_obj(obj)

        _obj = SystemConfigLoggingDto.parse_obj({

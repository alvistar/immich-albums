...
class AllJobStatusResponseDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["backgroundTask", "faceDetection", "facialRecognition", "library", "metadataExtraction", "migration", "search", "sidecar", "smartSearch", "storageTemplateMigration", "thumbnailGeneration", "videoConversion"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "backgroundTask": JobStatusDto.from_dict(obj.get("backgroundTask")) if obj.get("backgroundTask") is not None else None,
            "faceDetection": JobStatusDto.from_dict(obj.get("faceDetection")) if obj.get("faceDetection") is not None else None,
            "facialRecognition": JobStatusDto.from_dict(obj.get("facialRecognition")) if obj.get("facialRecognition") is not None else None,
            "library": JobStatusDto.from_dict(obj.get("library")) if obj.get("library") is not None else None,
            "metadataExtraction": JobStatusDto.from_dict(obj.get("metadataExtraction")) if obj.get("metadataExtraction") is not None else None,
            ...
            "smartSearch": JobStatusDto.from_dict(obj.get("smartSearch")) if obj.get("smartSearch") is not None else None,
            "storageTemplateMigration": JobStatusDto.from_dict(obj.get("storageTemplateMigration")) if obj.get("storageTemplateMigration") is not None else None,
            "thumbnailGeneration": JobStatusDto.from_dict(obj.get("thumbnailGeneration")) if obj.get("thumbnailGeneration") is not None else None,
            "videoConversion": JobStatusDto.from_dict(obj.get("videoConversion")) if obj.get("videoConversion") is not None else None
        })
        return _obj

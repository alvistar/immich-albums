...
class PeopleUpdateDto(BaseModel):
    ...
    PeopleUpdateDto
    """
    people: conlist(PeopleUpdateItem) = Field(...)
    __properties = ["people"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PeopleUpdateDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PeopleUpdateDto:
        """Create an instance of PeopleUpdateDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PeopleUpdateDto.parse_obj(obj)

        _obj = PeopleUpdateDto.parse_obj({
            "people": [PeopleUpdateItem.from_dict(_item) for _item in obj.get("people")] if obj.get("people") is not None else None
        })
        return _obj

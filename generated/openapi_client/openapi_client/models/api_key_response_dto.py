...
class APIKeyResponseDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> APIKeyResponseDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> APIKeyResponseDto:
        """Create an instance of APIKeyResponseDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return APIKeyResponseDto.parse_obj(obj)

        _obj = APIKeyResponseDto.parse_obj({

...
class UserResponseDto(BaseModel):
    ...
    __properties = ["avatarColor", "createdAt", "deletedAt", "email", "externalPath", "id", "isAdmin", "memoriesEnabled", "name", "oauthId", "profileImagePath", "shouldChangePassword", "storageLabel", "updatedAt"]

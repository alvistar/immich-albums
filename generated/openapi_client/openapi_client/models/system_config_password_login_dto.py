...
class SystemConfigPasswordLoginDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SystemConfigPasswordLoginDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SystemConfigPasswordLoginDto:
        """Create an instance of SystemConfigPasswordLoginDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SystemConfigPasswordLoginDto.parse_obj(obj)

        _obj = SystemConfigPasswordLoginDto.parse_obj({

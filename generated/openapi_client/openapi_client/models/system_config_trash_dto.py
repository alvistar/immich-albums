...
class SystemConfigTrashDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SystemConfigTrashDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SystemConfigTrashDto:
        """Create an instance of SystemConfigTrashDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SystemConfigTrashDto.parse_obj(obj)

        _obj = SystemConfigTrashDto.parse_obj({
            "days": obj.get("days"),

...
class AssetResponseDto(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "exifInfo": ExifResponseDto.from_dict(obj.get("exifInfo")) if obj.get("exifInfo") is not None else None,
            ...
            "smartInfo": SmartInfoResponseDto.from_dict(obj.get("smartInfo")) if obj.get("smartInfo") is not None else None,

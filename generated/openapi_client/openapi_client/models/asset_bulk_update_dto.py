...
class AssetBulkUpdateDto(BaseModel):
    ...
    remove_parent: Optional[StrictBool] = Field(default=None, alias="removeParent")
    stack_parent_id: Optional[StrictStr] = Field(default=None, alias="stackParentId")
    __properties: ClassVar[List[str]] = ["dateTimeOriginal", "ids", "isArchived", "isFavorite", "latitude", "longitude", "removeParent", "stackParentId"]

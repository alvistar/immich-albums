...
class UpdatePartnerDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdatePartnerDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdatePartnerDto:
        """Create an instance of UpdatePartnerDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdatePartnerDto.parse_obj(obj)

        _obj = UpdatePartnerDto.parse_obj({

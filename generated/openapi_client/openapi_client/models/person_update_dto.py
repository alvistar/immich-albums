...
class PersonUpdateDto(BaseModel):
    ...
    __properties = ["birthDate", "featureFaceAssetId", "isHidden", "name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PersonUpdateDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PersonUpdateDto:
        """Create an instance of PersonUpdateDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PersonUpdateDto.parse_obj(obj)

        _obj = PersonUpdateDto.parse_obj({

...
class PersonStatisticsResponseDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PersonStatisticsResponseDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PersonStatisticsResponseDto:
        """Create an instance of PersonStatisticsResponseDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PersonStatisticsResponseDto.parse_obj(obj)

        _obj = PersonStatisticsResponseDto.parse_obj({

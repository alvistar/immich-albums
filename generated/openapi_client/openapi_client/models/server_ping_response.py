...
class ServerPingResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerPingResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerPingResponse:
        """Create an instance of ServerPingResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServerPingResponse.parse_obj(obj)

        _obj = ServerPingResponse.parse_obj({
            "res": obj.get("res")
        })
        return _obj

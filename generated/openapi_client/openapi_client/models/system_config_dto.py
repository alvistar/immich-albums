...
class SystemConfigDto(BaseModel):
    ...
    logging: SystemConfigLoggingDto = Field(...)
    ...
    server: SystemConfigServerDto = Field(...)
    ...
    __properties = ["ffmpeg", "job", "library", "logging", "machineLearning", "map", "newVersionCheck", "oauth", "passwordLogin", "reverseGeocoding", "server", "storageTemplate", "theme", "thumbnail", "trash"]

...
class SystemConfigDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ffmpeg", "image", "job", "library", "logging", "machineLearning", "map", "newVersionCheck", "notifications", "oauth", "passwordLogin", "reverseGeocoding", "server", "storageTemplate", "theme", "trash", "user"]

...
class SystemConfigThemeDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SystemConfigThemeDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SystemConfigThemeDto:
        """Create an instance of SystemConfigThemeDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SystemConfigThemeDto.parse_obj(obj)

        _obj = SystemConfigThemeDto.parse_obj({

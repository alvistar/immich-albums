...
class AssetFullSyncDto(BaseModel):
    ...
    AssetFullSyncDto
    """ # noqa: E501
    last_creation_date: Optional[datetime] = Field(default=None, alias="lastCreationDate")
    ...
    __properties: ClassVar[List[str]] = ["lastCreationDate", "lastId", "limit", "updatedUntil", "userId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "lastCreationDate": obj.get("lastCreationDate"),

...
class SmartSearchDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["city", "country", "createdAfter", "createdBefore", "deviceId", "isArchived", "isEncoded", "isFavorite", "isMotion", "isNotInAlbum", "isOffline", "isVisible", "lensModel", "libraryId", "make", "model", "page", "personIds", "query", "size", "state", "takenAfter", "takenBefore", "trashedAfter", "trashedBefore", "type", "updatedAfter", "updatedBefore", "withArchived", "withDeleted", "withExif"]

...
class ChangePasswordDto(BaseModel):
    ...
    __properties = ["newPassword", "password"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ChangePasswordDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ChangePasswordDto:
        """Create an instance of ChangePasswordDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ChangePasswordDto.parse_obj(obj)

        _obj = ChangePasswordDto.parse_obj({

...
class DeleteAssetResponseDto(BaseModel):
    """
    DeleteAssetResponseDto
    """
    id: StrictStr = Field(...)
    status: DeleteAssetStatus = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeleteAssetResponseDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeleteAssetResponseDto:
        """Create an instance of DeleteAssetResponseDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeleteAssetResponseDto.parse_obj(obj)

        _obj = DeleteAssetResponseDto.parse_obj({
            "id": obj.get("id"),

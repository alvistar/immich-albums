...
class DownloadArchiveInfo(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DownloadArchiveInfo:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DownloadArchiveInfo:
        """Create an instance of DownloadArchiveInfo from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DownloadArchiveInfo.parse_obj(obj)

        _obj = DownloadArchiveInfo.parse_obj({

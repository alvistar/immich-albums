...
class ActivityApi:
    ...
    @validate_arguments
    def get_activities(self, album_id : StrictStr, asset_id : Optional[StrictStr] = None, type : Optional[ReactionType] = None, level : Optional[ReactionLevel] = None, user_id : Optional[StrictStr] = None, **kwargs) -> List[ActivityResponseDto]:  # noqa: E501
        """get_activities  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_activities(album_id, asset_id, type, level, user_id, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.get_activities_with_http_info(album_id, asset_id, type, level, user_id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_activities_with_http_info(self, album_id : StrictStr, asset_id : Optional[StrictStr] = None, type : Optional[ReactionType] = None, level : Optional[ReactionLevel] = None, user_id : Optional[StrictStr] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """get_activities  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_activities_with_http_info(album_id, asset_id, type, level, user_id, async_req=True)
        >>> result = thread.get()

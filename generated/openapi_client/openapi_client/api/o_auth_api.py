...
class OAuthApi:
    ...
    def generate_o_auth_config(
        ...
        """(Deprecated) generate_o_auth_config
        ...
        _param = self._generate_o_auth_config_serialize(
    ...
    @validate_call
    def generate_o_auth_config_with_http_info(
        self,
        o_auth_config_dto: OAuthConfigDto,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OAuthConfigResponseDto]:
        """(Deprecated) generate_o_auth_config
    ...
    @validate_call
    def generate_o_auth_config_without_preload_content(
        self,
        o_auth_config_dto: OAuthConfigDto,
        _request_timeout: Union[
            None,
    ...
    def _generate_o_auth_config_serialize(
        self,
        o_auth_config_dto,
        _request_auth,
        _content_type,

...
------------- | ------------- | -------------
[**create_key**](APIKeyApi.md#create_key) | **POST** /api-key | 
[**delete_key**](APIKeyApi.md#delete_key) | **DELETE** /api-key/{id} | 
[**get_key**](APIKeyApi.md#get_key) | **GET** /api-key/{id} | 
[**get_keys**](APIKeyApi.md#get_keys) | **GET** /api-key | 
[**update_key**](APIKeyApi.md#update_key) | **PUT** /api-key/{id} | 


# **create_key**
> APIKeyCreateResponseDto create_key(api_key_create_dto)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling APIKeyApi->delete_key: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of APIKeyApi->get_key:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling APIKeyApi->get_key: %s\n" % e)
```
...
# **get_keys**
> List[APIKeyResponseDto] get_keys()
...
# **update_key**
> APIKeyResponseDto update_key(id, api_key_update_dto)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.update_key(id, api_key_update_dto)
        print("The response of APIKeyApi->update_key:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling APIKeyApi->update_key: %s\n" % e)
```

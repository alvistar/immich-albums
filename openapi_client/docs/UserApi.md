...
# **get_user_count**
> UserCountResponseDto get_user_count(admin=admin)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_user_count(admin=admin)
        print("The response of UserApi->get_user_count:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UserApi->get_user_count: %s\n" % e)
```

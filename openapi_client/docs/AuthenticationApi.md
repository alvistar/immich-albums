...
# **admin_sign_up**
> AdminSignupResponseDto admin_sign_up(sign_up_dto)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.admin_sign_up(sign_up_dto)
        print("The response of AuthenticationApi->admin_sign_up:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AuthenticationApi->admin_sign_up: %s\n" % e)
```
...
|-------------|-------------|------------------|
**201** |  |  -  |
**400** | The server already has an admin |  -  |

...
class APIKeyCreateDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> APIKeyCreateDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> APIKeyCreateDto:
        """Create an instance of APIKeyCreateDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return APIKeyCreateDto.parse_obj(obj)

        _obj = APIKeyCreateDto.parse_obj({
            "name": obj.get("name")
        })
        return _obj

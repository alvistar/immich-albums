...
class AssetStatsResponseDto(BaseModel):
    ...
    """
    images: StrictInt = Field(...)
    total: StrictInt = Field(...)
    videos: StrictInt = Field(...)
    __properties = ["images", "total", "videos"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AssetStatsResponseDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AssetStatsResponseDto:
        """Create an instance of AssetStatsResponseDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AssetStatsResponseDto.parse_obj(obj)

        _obj = AssetStatsResponseDto.parse_obj({

...
class UserCountResponseDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserCountResponseDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserCountResponseDto:
        """Create an instance of UserCountResponseDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserCountResponseDto.parse_obj(obj)

        _obj = UserCountResponseDto.parse_obj({

...
class LogoutResponseDto(BaseModel):
    ...
    __properties = ["redirectUri", "successful"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LogoutResponseDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LogoutResponseDto:
        """Create an instance of LogoutResponseDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LogoutResponseDto.parse_obj(obj)

        _obj = LogoutResponseDto.parse_obj({

...
class OAuthAuthorizeResponseDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OAuthAuthorizeResponseDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OAuthAuthorizeResponseDto:
        """Create an instance of OAuthAuthorizeResponseDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OAuthAuthorizeResponseDto.parse_obj(obj)

        _obj = OAuthAuthorizeResponseDto.parse_obj({
            "url": obj.get("url")
        })
        return _obj

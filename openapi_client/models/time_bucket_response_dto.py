...
class TimeBucketResponseDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TimeBucketResponseDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TimeBucketResponseDto:
        """Create an instance of TimeBucketResponseDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TimeBucketResponseDto.parse_obj(obj)

        _obj = TimeBucketResponseDto.parse_obj({
            "count": obj.get("count"),

...
class AssetResponseDto(BaseModel):
    ...
    thumbhash: Optional[StrictStr] = Field(..., description="base64 encoded thumbhash")
    type: AssetTypeEnum = Field(...)
    updated_at: datetime = Field(..., alias="updatedAt")
    __properties = ["checksum", "deviceAssetId", "deviceId", "duration", "exifInfo", "fileCreatedAt", "fileModifiedAt", "id", "isArchived", "isExternal", "isFavorite", "isOffline", "isReadOnly", "libraryId", "livePhotoVideoId", "originalFileName", "originalPath", "owner", "ownerId", "people", "resized", "smartInfo", "tags", "thumbhash", "type", "updatedAt"]

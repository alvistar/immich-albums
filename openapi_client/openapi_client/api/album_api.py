...
class AlbumApi:
    ...
    @validate_arguments
    def get_album_info(self, id : StrictStr, without_assets : Optional[StrictBool] = None, key : Optional[StrictStr] = None, **kwargs) -> AlbumResponseDto:  # noqa: E501
        """get_album_info  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_album_info(id, without_assets, key, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.get_album_info_with_http_info(id, without_assets, key, **kwargs)  # noqa: E501

    @validate_arguments
    def get_album_info_with_http_info(self, id : StrictStr, without_assets : Optional[StrictBool] = None, key : Optional[StrictStr] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """get_album_info  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_album_info_with_http_info(id, without_assets, key, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def get_all_albums(self, shared : Optional[StrictBool] = None, asset_id : Annotated[Optional[StrictStr], Field(description="Only returns albums that contain the asset Ignores the shared parameter undefined: get all albums")] = None, **kwargs) -> List[AlbumResponseDto]:  # noqa: E501
        """get_all_albums  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_all_albums(shared, asset_id, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.get_all_albums_with_http_info(shared, asset_id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_all_albums_with_http_info(self, shared : Optional[StrictBool] = None, asset_id : Annotated[Optional[StrictStr], Field(description="Only returns albums that contain the asset Ignores the shared parameter undefined: get all albums")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """get_all_albums  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_all_albums_with_http_info(shared, asset_id, async_req=True)
        >>> result = thread.get()

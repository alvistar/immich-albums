...
class CreateProfileImageResponseDto(BaseModel):
    ...
    __properties = ["profileImagePath", "userId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateProfileImageResponseDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateProfileImageResponseDto:
        """Create an instance of CreateProfileImageResponseDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateProfileImageResponseDto.parse_obj(obj)

        _obj = CreateProfileImageResponseDto.parse_obj({

...
class AlbumResponseDto(BaseModel):
    ...
    __properties = ["albumName", "albumThumbnailAssetId", "assetCount", "assets", "createdAt", "description", "endDate", "hasSharedLink", "id", "lastModifiedAssetTimestamp", "owner", "ownerId", "shared", "sharedUsers", "startDate", "updatedAt"]

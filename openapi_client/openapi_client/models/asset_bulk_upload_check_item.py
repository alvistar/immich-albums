...
class AssetBulkUploadCheckItem(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AssetBulkUploadCheckItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AssetBulkUploadCheckItem:
        """Create an instance of AssetBulkUploadCheckItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AssetBulkUploadCheckItem.parse_obj(obj)

        _obj = AssetBulkUploadCheckItem.parse_obj({

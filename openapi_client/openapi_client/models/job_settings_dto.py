...
class JobSettingsDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> JobSettingsDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> JobSettingsDto:
        """Create an instance of JobSettingsDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return JobSettingsDto.parse_obj(obj)

        _obj = JobSettingsDto.parse_obj({
